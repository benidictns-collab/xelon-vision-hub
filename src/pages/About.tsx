...
const About = () => {
  const milestones = [
    ...
    { year: "2025", event: "Запуск производства первых цифровых детекторов XELON XRAY" },
    { year: "2025", event: "Подписание соглашения о строительстве завода в Новочеркасске" },
    { year: "2025", event: "Достижение 70% отечественных компонентов в производстве" },
    { year: "2026", event: "Планируемый запуск полного производственного цикла" },
  ];
