...
const About = () => {
  const milestones = [
    { year: "2025", event: "Основание компании КСEЛОН" },
    { year: "2025 Июль", event: "Подписанно соглашение на выставке ИННОПРОМ-2025 с правительством Ростовской области инвестиционный проект" },
    { year: "2026", event: "Открытие производственного комплекса на территории ТЕХНОПАРКА "БЕШТАУ" },
    { year: "2027", event: "Начало серийного производства" },
  ];
  ...
  const values = [
    ...
    },
    {
      icon: MapPin,
      title: "Глобальность",
      description: "Присутствие на рынках СНГ.ЕАЭС,БРИКС"
    }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-fade-in-up">
            ...
            <h1 className="section-title mb-6">
              Российский лидер в производстве цифровых детекторов
            </h1>
            <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              Мы создаем инновационные решения для медицинской, 
              промышленной и научной визуализации, объединяя российские 
              инженерные традиции с передовыми мировыми технологиями.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in-up">
              ...
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Создавать высокотехнологичные решения для визуализации полностью из отечественных комплектующих, которые 
