...
const About = () => {
  const milestones = [
    { year: "2009", event: "Основание компании КСEЛОН" },
    { year: "2012", event: "Первый медицинский детектор для рентгенографии" },
    { year: "2015", event: "Выход на международный рынок" },
    { year: "2018", event: "Открытие производственного комплекса" },
    { year: "2021", event: "Сертификация FDA для медицинских устройств" },
    { year: "2024", event: "Более 1000 установок по всему миру" },
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center animate-fade-in-up">
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
              Более 15 лет мы создаем инновационные решения для медицинской, 
