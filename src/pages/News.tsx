...
const News = () => {
  const newsItems = [
    {
      id: 1,
      title: "КСEЛОН подписал на выставке ИННОПРОМ-2025 Соглашение о сотрудничестве",
      excerpt: "На крупнейшей инновационной выставке компания КСЕЛОН в лице Исполнительного директора Смолина Никиты Георгиевича подписала соглашение о сотрудничестве с Правительством Ростовской области",
  ...
  const events = [
    {
      ...
      location: "Дубай, ОАЭ",
      description: "Российский Форум «Микроэлектроника» – ведущая межотраслевая коммуникационная площадка России "
    },
