  ...
  const advantages = [
    {
      ...
      description: "Полный производственный цикл на территории России. Планируется внесение в Реестр отечественной продукции в соответствии с 719 ПП Минпромторга",
      features: ["Независимость от импорта", "Реестр отечественной продукции", "Быстрая техподдержка"],
    ...
    },
    {
      icon: Award,
      title: "Качество",
      description: "Международные сертификаты качества и соответствие мировым стандартам медицинского оборудования",
      features: ["ISO 13485", "CE Mark", "FDA 510(k)"],
