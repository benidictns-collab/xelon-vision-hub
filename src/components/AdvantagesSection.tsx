  ...
  const advantages = [
    {
      ...
      description: "Полный производственный цикл на территории России с контролем качества на каждом этапе",
      features: ["Независимость от импорта", "Быстрая техподдержка", "Гибкие условия"],
